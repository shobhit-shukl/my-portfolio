        ...
        <main className="min-h-screen bg-[#020617] text-white">
            ...
            <section className="relative z-10 pt-48 sm:pt-56 pb-24 sm:pb-32 px-6 max-w-7xl mx-auto">
                <div className="flex flex-col items-center text-center space-y-10 sm:space-y-12 animate-reveal">
                    ...
                    {/* What I work with */}
                    <div className="w-full max-w-4xl pt-16 space-y-6">
                        <p className="text-[10px] font-black text-slate-600 uppercase tracking-[0.35em]">
                            What I work with
                        </p>
                        <div className="flex flex-wrap justify-center gap-2">
                            {[
                                ...
                                <span
                                    key={tech}
                                    className="text-[10px] font-mono tracking-[0.12em] uppercase px-3 py-1.5 rounded-full border border-white/10 bg-white/5 text-slate-400"
                                >
                                    {tech}
                                </span>
                            ))}
                    ...
                    <Link
                        href="/projects"
                        className="group inline-flex items-center gap-3 text-xs font-bold uppercase tracking-[0.25em] text-slate-500 hover:text-white transition-colors"
                    >
                        Or browse the live work
